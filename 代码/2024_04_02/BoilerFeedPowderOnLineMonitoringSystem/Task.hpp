...
public:
	...
	Data(std::string time,
		...
		, _temperature_pulverized(temperature_pulverized)
		, _temperature_mixing(temperature_mixing)
		, _pressure_left(pressure_left)
		, _pressure_right(pressure_right)
		, _area(area)
	{
...
public:
	...
	void run()
	{
		...
		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::WindSpeed(
			&primary_result.wind_speed
			, primary_value._temperature
			, primary_value._pressure_right - primary_value._pressure_left
			, 1.0);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalConcentration(
			&primary_result.pulverized_coal_concentration
			, primary_value._temperature
			, primary_value._temperature_pulverized
			, primary_value._temperature_mixing
		);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalMassFlowRate(
			&primary_result.pulverized_coal_mass_flow_rate
			, primary_result.wind_speed
			, primary_value._area
			, primary_value._temperature
			, primary_result.pulverized_coal_concentration
		...
		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::airVolume(
			&primary_result.air_volume
			, primary_result.wind_speed
			, primary_value._area);

		// 计算二次的
		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::WindSpeed(
			&secondary_result.wind_speed
			, secondary_value._temperature
			, secondary_value._pressure_right - secondary_value._pressure_left
			, 1.0);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalConcentration(
			&secondary_result.pulverized_coal_concentration
			, secondary_value._temperature
			, secondary_value._temperature_pulverized
			, secondary_value._temperature_mixing
		);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalMassFlowRate(
			&secondary_result.pulverized_coal_mass_flow_rate
			, secondary_result.wind_speed
			, secondary_value._area
			, secondary_value._temperature
			, secondary_result.pulverized_coal_concentration
		);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::airVolume(
			&secondary_result.air_volume
			, secondary_result.wind_speed
			, secondary_value._area);
		// 计算三次的

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::WindSpeed(
			&tertiary_result.wind_speed
			, tertiary_value._temperature
			, tertiary_value._pressure_right - tertiary_value._pressure_left
			, 1.0);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalConcentration(
			&tertiary_result.pulverized_coal_concentration
			, tertiary_value._temperature
			, tertiary_value._temperature_pulverized
			, tertiary_value._temperature_mixing
		);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::pulverizedCoalMassFlowRate(
			&tertiary_result.pulverized_coal_mass_flow_rate
			, tertiary_result.wind_speed
			, tertiary_value._area
			, tertiary_value._temperature
			, tertiary_result.pulverized_coal_concentration
		);

		MathematicalModelOfPrimaryAirPowderOnlineMonitoringSystem::airVolume(
			&tertiary_result.air_volume
			, tertiary_result.wind_speed
			, tertiary_value._area);
