...
public:
    ...
    void setupUi(QWidget *GiveAnAlarmClass)
    {
        ...
        GiveAnAlarmClass->resize(1230, 558);
        layoutWidget = new QWidget(GiveAnAlarmClass);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(30, 20, 931, 511));
        ...
        layoutWidget1 = new QWidget(GiveAnAlarmClass);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(1070, 90, 95, 381));
