...
QT_MOC_LITERAL(1, 15, 14), // "produceSignals"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 4) // "Task"

    },
    "ProducerThread\0produceSignals\0\0Task"
};
...
void ProducerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->produceSignals((*reinterpret_cast< Task(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ProducerThread::*)(Task );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProducerThread::produceSignals)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProducerThread::produceSignals(Task _t1)
{
