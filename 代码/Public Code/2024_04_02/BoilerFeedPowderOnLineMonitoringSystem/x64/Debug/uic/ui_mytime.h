...
public:
    ...
    void setupUi(QWidget *MyTimeClass)
    {
        ...
        MyTimeClass->resize(600, 400);
        layoutWidget = new QWidget(MyTimeClass);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(140, 60, 281, 101));
        ...
        layoutWidget1 = new QWidget(MyTimeClass);
        layoutWidget1->setObjectName(QString::fromUtf8("layoutWidget1"));
        layoutWidget1->setGeometry(QRect(170, 250, 211, 41));
