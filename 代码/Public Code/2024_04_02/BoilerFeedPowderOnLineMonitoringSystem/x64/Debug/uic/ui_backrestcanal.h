...
public:
    ...
    void setupUi(QWidget *BackrestCanalClass)
    {
        ...
        BackrestCanalClass->resize(1182, 654);
        label = new QLabel(BackrestCanalClass);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(410, 30, 371, 101));
        layoutWidget = new QWidget(BackrestCanalClass);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(110, 150, 1011, 361));
        ...
        modify_pushButton->setGeometry(QRect(350, 560, 161, 71));
        quit_pushButton = new QPushButton(BackrestCanalClass);
        quit_pushButton->setObjectName(QString::fromUtf8("quit_pushButton"));
        quit_pushButton->setGeometry(QRect(710, 560, 161, 71));

        retranslateUi(BackrestCanalClass);

        QMetaObject::connectSlotsByName(BackrestCanalClass);
    } // setupUi

    void retranslateUi(QWidget *BackrestCanalClass)
    {
...
namespace Ui {
    class BackrestCanalClass: public Ui_BackrestCanalClass {};
} // namespace Ui
