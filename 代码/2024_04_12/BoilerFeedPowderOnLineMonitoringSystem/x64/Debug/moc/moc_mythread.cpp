...
static const uint qt_meta_data_MyThread[] = {
 ...
 // signals: name, argc, parameters, tag, flags
       1,   31,   29,    2, 0x06 /* Public */,
       4,    1,   92,    2, 0x06 /* Public */,

 // slots: name, argc, parameters, tag, flags
       6,    0,   95,    2, 0x09 /* Protected */,
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyThread::*)(std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string , std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyThread::saveCoefficientSignals)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::saveCoefficientSignals(std::string _t1, std::string _t2, std::string _t3, std::string _t4, std::string _t5, std::string _t6, std::string _t7, std::string _t8, std::string _t9, std::string _t10, std::string _t11, std::string _t12, std::string _t13, std::string _t14, std::string _t15, std::string _t16, std::string _t17, std::string _t18, std::string _t19, std::string _t20, std::string _t21, std::string _t22, std::string _t23, std::string _t24, std::string _t25, std::string _t26, std::string _t27, std::string _t28, std::string _t29, std::string _t30, std::string _t31)
{
